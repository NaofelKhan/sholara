    ...
    >
      <div className="relative z-10 max-w-2xl">
        <h2
          ...
          style={{ fontFamily: 'Hanken Grotesk, sans-serif', color: C.onPrimary }}
        >
          Master Any Skill,<br />Share Your Brilliance.
        </h2>
        <p className="text-lg mb-8 opacity-90" style={{ color: C.onPrimaryContainer }}>
          The decentralized academic economy for knowledge exchange and professional growth.
        </p>
