    ...
    <header className="flex justify-between items-center w-full px-8 py-3 h-16 bg-white border-b border-[#c4c6cf] sticky top-0 z-40">
      <div className="flex items-center gap-8">
        ...
        <nav className="hidden lg:flex gap-6">
          <Link href="/my-courses" data-testid="link-my-courses" className="text-sm font-medium text-[#43474e] hover:text-[#002045]">
            My Courses
          </Link>
          <Link href="/request-skill" data-testid="link-skill-requests" className="text-sm font-medium text-[#43474e] hover:text-[#002045]">
            Skill Requests
          </Link>
